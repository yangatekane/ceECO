...
public class Stocks implements Serializable {
    ...
    public static class Stock implements Serializable {
        ...
        public Stock(String part_number, String description, int quantity, String amount, String barcode, String supplier, String date) {
            this.part_number = part_number;
            this.description = description;
            this.quantity = quantity;
            this.amount = amount;
        ...
        public Stock(String part_number, String description, int quantity, String amount, String barcode, String supplier) {
            this.part_number = part_number;
            this.description = description;
            this.quantity = quantity;
            this.amount = amount;
