 ...
 * @author Sean Owen
 */
final class MECARDContactEncoder extends com.htm.encode.ContactEncoder {

  private static final Pattern RESERVED_MECARD_CHARS = Pattern.compile("([\\\\:;])");
  private static final Pattern NEWLINE = Pattern.compile("\\n");
  private static final Pattern COMMA = Pattern.compile(",");
  private static final Formatter MECARD_FIELD_FORMATTER = new com.htm.encode.Formatter() {
    @Override
  ...
  public String[] encode(Iterable<String> names,
    ...
    appendUpToUnique(newContents, newDisplayContents, "N", names, 1, new com.htm.encode.Formatter() {
      @Override
      public String format(String source) {
    ...
    appendUpToUnique(newContents, newDisplayContents, "TEL", phones, Integer.MAX_VALUE, new com.htm.encode.Formatter() {
      @Override
      public String format(String source) {
