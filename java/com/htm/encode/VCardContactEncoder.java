 ...
 * @author Sean Owen
 */
final class VCardContactEncoder extends com.htm.encode.ContactEncoder {

  private static final Pattern RESERVED_VCARD_CHARS = Pattern.compile("([\\\\,;])");
  private static final Pattern NEWLINE = Pattern.compile("\\n");
  private static final Formatter VCARD_FIELD_FORMATTER = new com.htm.encode.Formatter() {
    @Override
